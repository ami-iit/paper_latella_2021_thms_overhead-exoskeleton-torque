...
% SUBJECTPARAMS computes sizes for model bounding boxes by extracting 
% dimensions directly from suit data. The convention for the reference frame
% is in Figure 60 of MVN user manual.
%
% Notes:
...
%   box (i.e., the point w.r.t. the COM is expressed)
% - for all the other links, the location of the joint reference frame
%   coincides with the bounding box origin (i.e., the point w.r.t. the COM
%   is expressed)
% - for the links defined with parallelepiped bounding box, the
%   convention for the size vector is: [DIM ALONG x, DIM ALONG y, DIM ALONG z]
% - for the links defined with cylinder bounding boxes x dimension is the diameter
